...
class CrudFNTDNTRates extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tableData: []
    ...
    componentDidMount() {
        axiosUtil.get("BillingInformation/getFntDntCommissionRates").then(response => response.data)
...
CrudFNTDNTRates.propTypes = {};

export default CrudFNTDNTRates;
